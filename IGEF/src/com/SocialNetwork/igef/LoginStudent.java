...
public class LoginStudent extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		incorrectloginnn = (TextView) rootView
				.findViewById(R.id.incorrectlogin);
			...
			public void onClick(View v) {
				...
				if (isInternetPresent) {
					new AsyncTask<Void, Void, Void>() {
						...
						ProgressDialog pd;
						String jsonStr, id11, full_name11, roll_no11, gender11,
								department11, year11, section11, contactno11,
								email11, devicetoken11, apiKey11,
								profilepicurl11, coverphoto11, status11,
								createdAt11;
						String value;
						...
						protected Void doInBackground(Void... params) {
							...
							HttpPost httppost = new HttpPost(
									"http://shypal.com/IGEF/task_manager/v1/login");
							List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
							nameValuePairs.add(new BasicNameValuePair(
									"roll_no", login_roll_no));
							nameValuePairs.add(new BasicNameValuePair(
							...
							try {
								...
								value = EntityUtils.toString(response
										.getEntity());
								...
								if (jsonStr != null) {
									...
									try {
										if (jsonObj.getString("error").equals(
											...
											System.out
													.println("Login sucessfull Json parsing stared");
											...
											email11 = jsonObj
													.getString("email");
											devicetoken11 = jsonObj
													.getString("devicetoken");
											apiKey11 = jsonObj
													.getString("apiKey");
											profilepicurl11 = jsonObj
													.getString("profilepicurl");
											coverphoto11 = jsonObj
											...
											final IGEFSharedPrefrence obj = new IGEFSharedPrefrence(
													getActivity());

											IGEFSharedPrefrence.setID(id11);
											IGEFSharedPrefrence
													.setFULL_NAME(full_name11);
											IGEFSharedPrefrence
													.setROLL_NO(login_roll_no);
											IGEFSharedPrefrence
													.setGENDER(gender11);
											IGEFSharedPrefrence
													.setDEPARTMENT(department11);
											IGEFSharedPrefrence.setYEAR(year11);
											IGEFSharedPrefrence
													.setSECTION(section11);
											IGEFSharedPrefrence
													.setCONTACTNO(contactno11);
											IGEFSharedPrefrence
													.setEMAIL(email11);
											IGEFSharedPrefrence
													.setDEVICETOKEN(devicetoken11);
											IGEFSharedPrefrence
													.setAPI_KEY(apiKey11);
											IGEFSharedPrefrence
													.setPROFILEPICURL(profilepicurl11);
											IGEFSharedPrefrence
													.setCOVERPHOTO(coverphoto11);
											IGEFSharedPrefrence
													.setSTATUS(status11);
											IGEFSharedPrefrence
													.setCREATEDAT(createdAt11);
											IGEFSharedPrefrence
													.setPASSWORD(login_password);
											IGEFSharedPrefrence.setPHOTOURl("http://shypal.com/IGEF/task_manager/uploadedimages/");
											...
											if (jsonObj
													.getString("message")
													.equals("LoginNow failed. Incorrect credentials")) {
												flag = 2;
						...
						private void show(int flag) {
							...
							if (flag == 1) {
								...
								if (IGEFSharedPrefrence.getPROFILEPICURL()
										.equals("null")) {

									System.out
											.println("no image in profilepic url --> moving to photoupload activity");

									Intent intt = new Intent(getActivity(),
											PhotoUpload.class);
								...
								else if (IGEFSharedPrefrence.getCOVERPHOTO()
										.equals("null")) {
									System.out
											.println("no COver Photo Set --> moving to CoverPhotoChooser activity");

									Intent intt = new Intent(getActivity(),
											CoverPhotoChooser.class);
									getActivity().startActivity(intt);
									getActivity().finish();
...
//									getActivity().registerReceiver(rr, iff);
							...
							if (flag == 2) {
								...
								incorrectloginnn
										.setText("Roll No. and Password do not match.!!");
								incorrectloginnn.setVisibility(View.VISIBLE);

								System.out
										.println("Roll No. and Password do not match.!!");
							}
							...
							if (flag == 3) {
								...
								incorrectloginnn
										.setText("Login Failed, Required fields missing.!!");
								incorrectloginnn.setVisibility(View.VISIBLE);
	...
	public void onDestroy() {
		...
		try {
			getActivity().unregisterReceiver(rr);
	...
	class MyReciever extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			String mydata = intent.getStringExtra("photodownload");
			// Toast.makeText(getActivity(), mydata, Toast.LENGTH_SHORT);
